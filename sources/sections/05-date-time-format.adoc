...
times have the same number of fractional second digits, and all years
...
time-ordered sequence will result (in descending order if the years
start with "-"). The presence of optional punctuation would violate this
characteristic.
